...
if database_url:
    ...
    # Add connection parameters for better network handling
    separator = '&' if '?' in database_url else '?'
    database_url += f'{separator}connect_timeout=10&options=-c statement_timeout=30000'
    ...
    app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///hitblow.db'
    print("WARNING: Using SQLite (development only)")
